...
function Home({ navigation }) {
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Text
                                                style={{
                                                    marginLeft: SIZES.base, color: COLORS.white, ...FONTS.h3
                                                }}>
                                                Play Now
                                            </Text>
                                        </View>
    ...
    function renderContinueWachingSection() {
        return (
            <View style={{
                marginTop: SIZES.padding
            }}>
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    {/* Name */}
                                    <Text style={{ marginTop: SIZES.base, color: COLORS.white, ...FONTS.h3 }}>
                                        {item.name}
                                    </Text>
                                    {/* Progress Bar */}
                                    <ProgressBar
